...
if (Meteor.isClient) {
    ...
    Meteor.startup( function() {
      ...
      //  Session.set('ipAndPort', 'http://192.168.0.105:3300/images/');
      //  Session.set('configInfos', 'http://192.168.0.105:3300/config-items/');
      //  Session.set('repairInfos', 'http://192.168.0.105:3300/repair-items/');
