...
Template.repairMessageBoard.helpers({
...
Template.repairMessageBoard.events({
    ...
    'submit .repair-order-parts':function(e) {
        ...
        urgency_order = 11;
         console.log(user_order, partNumber_order, storageLocation_order, point_of_use_order,
              reason_order, urgency_order)
        Meteor.call('repair_parts_on_order', user_order, partNumber_order, quantityNeeded_order, storageLocation_order, point_of_use_order,
